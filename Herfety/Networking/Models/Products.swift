...
struct Products: Codable {
    ...
    let brand, category, coupon: JSONNull?
    let cartItems, carts, productImagesGallery, productReviews: [JSONAny]?
    let wishList, users, adminProducts, admins: [JSONAny]?
    let vendors, vendorProducts, orders, ordersProducts: [JSONAny]?
